...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent intent = new Intent(MainActivity.this, AlamService.class);
...
// thấy no gạch ngang k kệ nó của tôi cũng v mà
